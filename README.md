...
Compared shopping behavior across categories
Visualized patterns using charts and graphs
4. SQL Analysis
Imported the dataset into PostgreSQL
Executed SQL queries for deeper business analysis
Used filtering, grouping, aggregation, and analytical queries
